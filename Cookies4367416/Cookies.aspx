<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cookies.aspx.cs" Inherits="Cookies4367416.Cookies" %>
	...
	<asp:TableRow runat="server">
		...
		<asp:TableCell runat="server">
			<asp:DropDownList ID="ddlSupplier" runat="server">
				<asp:ListItem>KIKE</asp:ListItem>
				<asp:ListItem>PUMBA</asp:ListItem>
				<asp:ListItem>JOLDAN</asp:ListItem>
				<asp:ListItem>COBE</asp:ListItem>
			</asp:DropDownList>
		</asp:TableCell>
	</asp:TableRow>
	<asp:TableRow runat="server">
